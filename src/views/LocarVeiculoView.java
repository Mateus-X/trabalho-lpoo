...
public class LocarVeiculoView extends JFrame {
    ...
    private JComboBox<String> cbClientesInfo;
    ...
    public LocarVeiculoView(LocacaoController locacaoController, VeiculoController veiculoController,
    ...
    private JPanel createFilterPanel() {
        ...
        filterPanel.add(new JLabel("Selecionar Cliente (CPF):"));
        cbClientesInfo = new JComboBox<>();
        filterPanel.add(cbClientesInfo);
        ...
        btnLocar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (row >= 0) {
                    ...
                    String cpf = (String) cbClientesInfo.getSelectedItem();
                    int dias = 1;
                    try {
    ...
    private void atualizarClientesCombo() {
        cbClientesInfo.removeAllItems();
        clienteController.listarTodosClientes().forEach(cliente -> cbClientesInfo.addItem(cliente.getCPF()));
    }
    ...
    private void atualizarTabela() {
        ...
        List<Veiculo> veiculos = veiculoController.filtrarVeiculos(tipo, marca, categoria)
                .stream()
                .filter(t -> t.getEstado() == Estado.DISPONIVEL || t.getEstado() == Estado.NOVO)
    ...
    // Getters
    public JComboBox<String> getCbClientesInfo() {
        return cbClientesInfo;
    }
    ...
    public VeiculoTableModel getTableModel() {
        return tableModel;
    }

    public JFormattedTextField getTxtDiasLocacao() {
        return txtDiasLocacao;
    }

    public JFormattedTextField getTxtDataLocacao() {
        return txtDataLocacao;
    }
